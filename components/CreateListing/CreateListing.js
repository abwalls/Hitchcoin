...
Amplify.configure({
  API: {
    graphql_endpoint:
      "https://kldld5zlbrfyvo2nlibxi2cu3e.appsync-api.us-east-1.amazonaws.com/graphql",
  },
});
    ...
    <KeyboardAvoidingView behaviour="padding" style={styles.signup_container}>
      ...
      >
        <View style={styles.signup_form_container}>
          <Text style={styles.signup_banner_text}>RIDE DETAILS</Text>
          <TextInput
        ...
        <View style={styles.signup_actions_container}>
          <TouchableOpacity onPress={() => navigation.navigate("Menu")}>
            <Text style={styles.login_button}>BACK TO MENU</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={requestRide} style={styles.signup_button}>
            <Text style={styles.signup_text}>REQUEST RIDE</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </KeyboardAvoidingView>
